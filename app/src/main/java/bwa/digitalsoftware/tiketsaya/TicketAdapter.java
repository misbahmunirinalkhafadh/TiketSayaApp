...
public class TicketAdapter extends RecyclerView.Adapter<TicketAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.tv_nama_wisata.setText(myTicket.get(i).getNama_wisata());
        myViewHolder.tv_lokasi.setText(myTicket.get(i).getLokasi());
        myViewHolder.tv_jumlah_tiket.setText(myTicket.get(i).getJumlah_tiket() + " Tickets");
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotomyticketdetails = new Intent(context, MyTicketDetailAvtivity.class);
