...
public class HomeActivity extends AppCompatActivity {
    ...
    LinearLayout btn_ticket_pisa, btn_ticket_torri, btn_ticket_pagoda, btn_ticket_sphinx, btn_ticket_candi, btn_ticket_monas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ticket_sphinx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotopisaticket = new Intent(HomeActivity.this,TicketDetailActivity.class);
                gotopisaticket.putExtra("jenis_tiket", "Sphink");
                startActivity(gotopisaticket);
            }
        });
